...
namespace FacebookProjectRxWeb.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(FacebookProjectRxWeb.Models.Main.LanguageContent.ComponentLanguageContents))]
